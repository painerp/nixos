{
  ...
  inf-agentmemory-provider-env = ./inf/agentmemory-provider.env.age;
  ...
  cit-peanut-env = ./cit/peanut.env.age;
  cit-paperless-env = ./cit/paperless.env.age;
  cit-paperless-pg-env = ./cit/paperless-pg.env.age;
